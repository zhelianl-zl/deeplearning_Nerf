...
class StratifiedRaysampler(torch.nn.Module):
    ...
    def forward(
        ...
        # print("origines shape = ", ray_bundle.origins.reshape(-1,1,3).repeat(1, self.n_pts_per_ray, 1).shape)
        # print("directions shape = ", ray_bundle.directions.reshape(-1,1,3).repeat(1, self.n_pts_per_ray, 1).shape)
